...
export function ContactContent() {
  ...
  const contactMethods = [
    ...
    },
    {
      title: "WhatsApp",
      value: "Chat with us",
      href: siteConfig.social?.whatsapp || "https://wa.me/94770000000",
      icon: "whatsapp",
    },
    {
      title: "Email",
    ...
    {
      title: "Showroom",
      value: siteConfig.showroom?.location || "Wellaweriya",
      href: "/showroom",
      icon: "location",
    },
  ];
          ...
          <div>
            ...
            <dl className="mt-8 space-y-4">
              ...
              <div>
                ...
                <dd className="text-sm font-medium">{siteConfig.showroom?.hours}: {siteConfig.showroom?.time}</dd>
              </div>
            </dl>
          </div>
